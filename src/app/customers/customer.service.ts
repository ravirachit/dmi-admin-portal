...
import {EMPLOY} from './customers-list';
...
function sort(employ: Customer[], column: string, direction: string): Customer[] {
  if (direction === '') {
    return employ;
  } else {
...
function matches(Employee: Customer, term: string, pipe: PipeTransform) {
...
export class CustomerService {
  ...
  private employ$ = new BehaviorSubject<Customer[]>([]);
